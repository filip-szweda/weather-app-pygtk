...
class BaseWindow(Gtk.Window):
    ...
    def build_menu_bar(self):
        ...
        localisation.set_name("menu-item")  
...
class LatitudeWindow(BaseWindow):
    def __init__(self):
        ...
        latitude_label = Gtk.Label(label="Podaj szerokość geograficzną:")
        inner_box.pack_start(latitude_label, False, False, 0)
...
class ChangeCityWindow(BaseWindow):
    def __init__(self):
        ...
        latitude_label = Gtk.Label(label="Podaj miasto:")
        inner_box.pack_start(latitude_label, False, False, 0)
